...
variable "project_type" {
  description = "A unique identifier between security and data projects. Input is either 'sec' or 'data'"
  type        = string
}

variable "project_unique_purpose" {
  description = "Purpose of project to be added to project name. Input is type string"
  type        = string
}
